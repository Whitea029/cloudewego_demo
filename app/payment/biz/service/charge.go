...
import (
	...
	"github.com/Whitea029/whmall/app/payment/biz/model"
	payment "github.com/Whitea029/whmall/rpc_gen/kitex_gen/payment"
...
func (s *ChargeService) Run(req *payment.ChargeReq) (resp *payment.ChargeResp, err error) {
	...
	err = model.NewPaymentLogQuery(*mysql.DB, s.ctx).CreatePaymentLog(&model.PaymentLog{
		UserId:        req.UserId,
		OrderId:       req.OrderId,
